const config = {
    thresholds: {
        questionAnswerSimilarity: 0.9, // Minimum similarity score for question-answer pairs to be considered similar
        answerSimilarity: 0.9, // Minimum similarity score for answers to be considered similar
