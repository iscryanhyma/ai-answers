const config = {
    thresholds: {
        questionAnswerSimilarity: 0.7, // Minimum similarity score for question-answer pairs to be considered similar
    ...
    searchLimits: {
        ...
        topQAMatchesForHighScoreFallback: 10 // Number of top QA matches to check for high score fallback
    },
    penalties: {
