  ...
  try {
    ...
    if (deploymentMode === 'Vercel') {
      try {
        ...
        await EvaluationService.evaluateInteraction(dbInteraction, chatId, interaction.selectedAI);
      ...
      EvaluationService.evaluateInteraction(dbInteraction, chatId, interaction.selectedAI)
        .then(() => {
